#include <stdio.h>//Permite entrada e saída
#include <string.h>//Permite trabalhar com strings

//Ação para evitar bug na hora de pegar os dados
void limpar_entrada() {
char c;
while ((c = getchar()) != '\n' && c != EOF) {}
}

//COMANDO PARA QUE A QUEBRA DE LINHA NÃO SEJA ARMAZENADA
...
strtok(buffer, "\n");
	...
	int main()
	{
		...
		scanf("%lf", &salario1);//Precisa ter o & porque interage com a memória
